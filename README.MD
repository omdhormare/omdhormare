...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=F7B93E&lines=PHP+%7C+Python+%7C+Java+Developer+C++++;Passionate+about+Java+Developer;Always+Learning+New+Technologies...+Code+Is+My+Passion;Innovation+Through+Code;Building+The+Future+With+Programming...+Solving+Problems+With+Code;Embracing+Challenges+Everyday;Continuous+Learning+Is+The+Key...+Coding+Is+My+Superpower;Building+Solutions+One+Line+At+A+Time;Let's+Code+Together...+Stay+Curious+&+Keep+Coding;Code+Your+Future;Dream+Big+And+Code+Bigger...&center=true&width=500&height=50">
</p>
